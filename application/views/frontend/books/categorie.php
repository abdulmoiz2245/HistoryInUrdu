                ...
                <div class="right">
                    <div class="recipes_items_sidebar">
                        <div class="sidebar_recent_post">
                            ...
                            <a href="<?= base_url() ?>/books/<?= $recent_post->route_name ?>">
                        ...
                        <div class="recipes_items_sidebar">
                        <div class="sidebar_recent_post" style="margin-top: 150px; margin-bottom:300px">
                        ...
                        <div class="left_main">
                            <?php if($posts){ ?>
                                <?php foreach($posts as $post): ?>
                                    <div><a href="<?= base_url() ?>/book/<?= $post[0]->route_name ?>"><img src="<?= base_url('uploads/admin') ?>/<?= $post[0]->image?>" alt=""></a>
                                        <h1><?=$post[0]->title ?>
                                        </h1>
                                       
                                        <p><?php $str = word_limiter($post[0]->body , 40);
                                            echo   strip_tags( $str) ; ?></p>
                                        <a href="<?= base_url() ?>/book/<?= $post[0]->route_name ?>" class="download_now"> ڈاؤن لوڈ کریں</a>
                                    </div>
                                <?php endforeach; ?>
                            <?php }else{ ?>
