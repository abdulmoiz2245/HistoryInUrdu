        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="user-box">
                    <div class="user-img">
                        <img src="<?= base_url("assets/admin") ?>/images/users/user-1.jpg" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                ...
                <div class="p-3">
                    <div class="inbox-widget">
                        ...
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="<?= base_url("assets/admin") ?>/images/users/user-6.jpg" class="rounded-circle" alt=""></div>
